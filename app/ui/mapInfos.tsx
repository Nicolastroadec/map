...
export default function MapInfos({ data }: MapsDetailsData) {
    ...
    return (
        <div className="flex flex-col text-white xl:w-1/3 w-full  xl:h-[500px] mb-5 z-0 p-10" >
            ...
            <p className="flex relative mb-3 text-xl rounded bg-[#1d2d44] w-fit cursor-pointer hover:bg-[#3e5c76]"><a className="p-2 pl-4 pr-4" href={site} target="_blank">Plus d&apos;infos</a></p>
        </div >
    )
}